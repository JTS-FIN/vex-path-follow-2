...
#define TURNING_SPEED_STAGE1 23
#define TURNING_SPEED_STAGE2 30
#define TURN_OVER_THE_TAPE_DEGREES 1
#define MAX_ROTATION_DEGREES_STAGE1 45
#define MAX_ROTATION_DEGREES_STAGE2 140
...
task main()
{
	...
	while (1) {
		...
		if (currentState == STATE_ON_BASE) {
			...
			repeatUntil(abs(getGyroDegrees(port4)) > TURN_OVER_THE_TAPE_DEGREES) {
