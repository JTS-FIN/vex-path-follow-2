...
#define BASE_MOVEMENT_SPEED 23
#define TURNING_SPEED_STAGE1 22
#define TURNING_SPEED_STAGE2 27
#define TURN_OVER_THE_TAPE_DEGREES 1
#define MAX_ROTATION_DEGREES_STAGE1 50
...
task main()
{
	...
	while (1) {
		...
		if (currentState == STATE_ON_BASE) {
			...
			movementSpeed = BASE_MOVEMENT_SPEED + (seenTapeDuration / 1000) * 10;
